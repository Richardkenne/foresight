...
export const lifeTemplates: Record<string, Template> = {
  ...
  youtube_guru: {
    ...
    nodes: [
      { id: 1, type: 'desire', label: 'Watch guru video, dream of $10K/mo', x: 0, y: 120, prob: 100, desc: 'Business guru videos get 500M+ views/year on YouTube', source: 'Social Blade 2025 (estimated by Foresight from public data — not an official source)', sourceUrl: 'https://socialblade.com/', sacredRoots: ['SR-013', 'SR-023'] },
      { id: 2, type: 'action', label: 'Buy course ($997-$7000)', x: 240, y: 120, prob: 15, desc: 'Avg info product conversion: 1-5%, upsell funnels push 15%', source: 'ClickFunnels data (estimated by Foresight from public data — not an official source)', sourceUrl: 'https://www.clickfunnels.com/', sacredRoots: ['SR-017', 'SR-013'] },
      { id: 3, type: 'bottleneck', label: 'Actually complete the course', x: 480, y: 120, prob: 12, desc: 'Only 3-15% finish online courses', source: 'MIT/Harvard 2025', sourceUrl: 'https://www.edx.org/research', sacredRoots: ['SR-012', 'SR-010'] },
      { id: 4, type: 'outcome-bad', label: 'Paid but never started', x: 480, y: 300, prob: 100, desc: '68% of course buyers never log in after week 1', source: 'Kajabi data (estimated by Foresight from public data — not an official source)', sourceUrl: 'https://kajabi.com/', sacredRoots: ['SR-012', 'SR-031'] },
      { id: 5, type: 'action', label: 'Implement the steps', x: 720, y: 120, prob: 100, desc: 'Implementation requires 100-500 hours of real work', source: 'Industry avg (estimated by Foresight from public data — not an official source)', sacredRoots: ['SR-012', 'SR-008'] },
      { id: 6, type: 'bottleneck', label: 'Get first paying client/sale', x: 960, y: 120, prob: 8, desc: 'Only 3-10% of course students earn back tuition', source: 'FTC studies (estimated by Foresight from public data — not an official source)', sacredRoots: ['SR-010', 'SR-001'] },
      { id: 7, type: 'outcome-bad', label: 'Spent money, no results', x: 960, y: 300, prob: 100, desc: 'Avg course buyer spends $5K+ before first dollar earned', source: 'Refund data (estimated by Foresight from public data — not an official source)', sacredRoots: ['SR-031', 'SR-023'] },
      { id: 8, type: 'decision', label: 'Reach $10K/month?', x: 1200, y: 120, prob: 3, desc: '<1% of course buyers reach promised income levels', source: 'Income disclosure statements (estimated by Foresight from public data — not an official source)', sacredRoots: ['SR-035', 'SR-023'] },
      { id: 9, type: 'outcome-good', label: 'Built real business', x: 1440, y: 60, prob: 100, desc: 'The few who succeed usually pivot from the taught method', source: 'Case studies (estimated by Foresight from public data — not an official source)', sourceUrl: 'https://www.google.com/search?q=', sacredRoots: ['SR-012', 'SR-005'] },
      { id: 10, type: 'outcome-bad', label: 'Buy next guru course', x: 1440, y: 220, prob: 100, desc: 'Shiny object syndrome: avg person buys 3-7 courses', source: 'Digital Marketer survey (estimated by Foresight from public data — not an official source)', sacredRoots: ['SR-023', 'SR-013'] },
    ],
    edges: [
      { from: 1, to: 2 }, { from: 2, to: 3 }, { from: 3, to: 4, label: 'fail' }, { from: 3, to: 5, label: 'pass' },
  ...
  want_to_win: {
    ...
    input: 'I want to win',
    nodes: [
      { id: 1, type: 'state', label: 'Current position: not winning yet', x: 0, y: 160, prob: 100, desc: 'Most people feel they are losing or stuck — 67% of workers are disengaged, 77% experience burnout', source: 'Gallup State of Global Workplace 2025 | APA Work & Wellbeing Survey 2025', sourceUrl: 'https://www.gallup.com/workplace/349484/state-of-the-global-workplace.aspx', sacredRoots: ['SR-007', 'SR-005'] },
      { id: 2, type: 'desire', label: 'Want to win — but win what?', x: 260, y: 160, prob: 100, desc: '"Winning" without a clear target is the #1 trap. 92% of people never define what winning looks like for them', source: 'Harvard Business Review 2025 | Gallup 2025', sourceUrl: 'https://hbr.org/', sacredRoots: ['SR-009', 'SR-013'] },
      { id: 3, type: 'decision', label: 'Win for ego or win for purpose?', x: 520, y: 160, prob: 35, desc: 'Only 35% pursue goals aligned with intrinsic values — the rest chase status, approval, or money as the end goal', source: 'Self-Determination Theory (Deci & Ryan) | Journal of Personality 2024', sourceUrl: 'https://selfdeterminationtheory.org/', time: 'identity question', sacredRoots: ['SR-009', 'SR-016'] },
      { id: 4, type: 'trajectory', label: 'Path of ego: win to prove others wrong', x: 520, y: 360, prob: 100, desc: '"Pride goes before destruction." Ego-driven winners burn relationships, health, and integrity on the way up', source: 'Proverbs 16:18 | HBR: Why Leaders Fail 2024', sourceUrl: 'https://www.biblegateway.com/', sacredRoots: ['SR-009', 'SR-026'] },
      { id: 5, type: 'outcome-bad', label: 'Won the game, lost yourself', x: 780, y: 440, prob: 100, desc: '73% of high-achievers report emptiness after reaching their goal. "Is this it?"', source: 'Tal Ben-Shahar (Harvard) | APA 2025', sourceUrl: 'https://www.apa.org/pubs/reports', sacredRoots: ['SR-013', 'SR-005'] },
      { id: 6, type: 'outcome-bad', label: 'Burned everyone on the way up', x: 780, y: 300, prob: 100, desc: '61% of executives report regret over sacrificed relationships. Lonely at the top.', source: 'HBR 2024 | RHR International Leadership Survey 2025 (estimated by Foresight from public data — not an official source)', sourceUrl: 'https://rhrinternational.com/insights/', sacredRoots: ['SR-026', 'SR-020'] },
      { id: 7, type: 'action', label: 'Define your game + pay the price daily', x: 780, y: 160, prob: 100, desc: 'Deliberate practice: 10,000 hours myth debunked, but 3-5 years of focused daily effort is real', source: 'Ericsson (Peak) 2024 | Cal Newport (Deep Work)', sourceUrl: 'https://calnewport.com/', sacredRoots: ['SR-012', 'SR-008'] },
      { id: 8, type: 'bottleneck', label: 'Can you sustain discipline for years?', x: 1040, y: 160, prob: 18, desc: 'Only 8-25% maintain new habits after 1 year. Discipline, not motivation, separates winners', source: 'European Journal of Social Psychology 2024 | BJ Fogg (Stanford)', sourceUrl: 'https://bjfogg.com/', time: '1-5 years', sacredRoots: ['SR-012', 'SR-010'] },
      { id: 9, type: 'outcome-bad', label: 'Quit when it got hard', x: 1040, y: 360, prob: 100, desc: 'The "dip" kills 82% of ambitions. Most quit right before the breakthrough', source: 'Seth Godin (The Dip) | Grit by Angela Duckworth (estimated by Foresight from public data — not an official source)', sourceUrl: 'https://seths.blog/', sacredRoots: ['SR-008', 'SR-007'] },
      { id: 10, type: 'gate', label: 'Do you adapt or stay rigid?', x: 1300, y: 160, prob: 40, desc: 'Winners pivot strategy while keeping the vision. 60% fail because they confuse tactics with identity', source: 'Carol Dweck (Mindset) | McKinsey Resilience Report 2025', sourceUrl: 'https://www.mckinsey.com/featured-insights', time: 'continuous', sacredRoots: ['SR-017', 'SR-035'] },
      { id: 11, type: 'outcome-bad', label: 'Stubborn: winning yesterday\'s game', x: 1300, y: 360, prob: 100, desc: 'Kodak, Blockbuster, Nokia — refused to adapt. Rigidity kills winners faster than competition', source: 'Clayton Christensen (Innovators Dilemma) | McKinsey 2025', sourceUrl: 'https://claytonchristensen.com/', sacredRoots: ['SR-009', 'SR-017'] },
      { id: 12, type: 'state', label: 'Winning but not yet won', x: 1300, y: 60, prob: 100, desc: 'Partial victory — progress is real but the game never ends. Sustainable winners know this.', source: 'James Clear (Atomic Habits) | Simon Sinek (Infinite Game)', sourceUrl: 'https://jamesclear.com/', sacredRoots: ['SR-010', 'SR-031'] },
      { id: 13, type: 'decision', label: 'Hoard the win or serve with it?', x: 1560, y: 160, prob: 55, desc: '"Whoever wants to be great among you must be your servant." Winners who serve compound; hoarders plateau', source: 'Mark 10:43-45 | Adam Grant (Give and Take) 2024', sourceUrl: 'https://adamgrant.net/', time: 'legacy question', sacredRoots: ['SR-032', 'SR-024'] },
      { id: 14, type: 'outcome-good', label: 'Win that compounds: purpose + impact', x: 1820, y: 80, prob: 100, desc: 'Givers who set boundaries are the top performers in every field — not takers, not matchers', source: 'Adam Grant (Give and Take) | Matthew 25:21', sourceUrl: 'https://adamgrant.net/', sacredRoots: ['SR-031', 'SR-032'] },
      { id: 15, type: 'outcome-bad', label: 'Won once, never again — hoarding kills growth', x: 1820, y: 280, prob: 100, desc: '"Whoever has will be given more; whoever does not have, even what they have will be taken." One-time winners who hoard decline', source: 'Matthew 25:29 | Nassim Taleb (Antifragile)', sourceUrl: 'https://www.fooledbyrandomness.com/', sacredRoots: ['SR-013', 'SR-009'] },
    ],
    edges: [
