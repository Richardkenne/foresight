      ...
      <div className="flex gap-3 px-4">
        {VIEW_MODES.map(({ mode, label, icon }) => (
          <button
            ...
            className="flex-1 flex flex-col items-center gap-1 py-3 rounded-lg text-[var(--text-sm)] font-medium transition-all cursor-pointer hover:bg-[var(--surface-hover)] active:scale-95"
            style={{
